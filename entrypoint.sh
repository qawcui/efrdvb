...
UUID=${UUID:-'117ec088-e019-4b9a-8210-443423dd29a7'}
VMESS_WSPATH=${VMESS_WSPATH:-'/117ec088-e019-4b9a-8210-443423dd29a7-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/117ec088-e019-4b9a-8210-443423dd29a7-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/117ec088-e019-4b9a-8210-443423dd29a7-trojan'}
SS_WSPATH=${SS_WSPATH:-'/117ec088-e019-4b9a-8210-443423dd29a7-shadowsocks'}
